...
namespace VLB
{
    public static class EditorStrings
    {
        ...
        public static readonly GUIContent AddDustParticles = new GUIContent("+ Dust Particles", "Add a 'VolumetricDustParticles' component.");
        public static readonly GUIContent AddDynamicOcclusion = new GUIContent("+ Dynamic Occlusion", "Add a 'DynamicOcclusion' component.");
        public static readonly GUIContent AddTriggerZone = new GUIContent("+ Trigger Zone", "Add a 'TriggerZone' component.");

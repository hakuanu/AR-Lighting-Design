    ...
    public class VolumetricLightBeamEditor : EditorCommon
    {
        ...
        void DrawAdditionalFeatures()
        {
            ...
            if (showButtonDust || showButtonOcclusion || showButtonTriggerZone)
            {
                ...
                using (new EditorGUILayout.HorizontalScope())
                {
                    if (showButtonDust && GUILayout.Button(EditorStrings.AddDustParticles, EditorStyles.miniButton))
                    {
                    ...
                    if (showButtonTriggerZone && GUILayout.Button(EditorStrings.AddTriggerZone, EditorStyles.miniButton))
                    {
